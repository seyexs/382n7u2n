<?php
class TUserAccessDataController extends Controller
{
	/**
    ...
    */
    ...
    public function actionRead(){
            ...
            $total = TUserAccessData::model()->count(array(
				'condition'=>'deleted=0'
			));
	...
	{
		$model=TUserAccessData::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tuser-access-data-form')
		{
