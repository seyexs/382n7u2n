...
echo "<?php";
?> $this->beginWidget('ext.widgets.XPanel', array('title' => '<?php echo $label; ?>', 'width' => 900)); 
?>
<div class="form">
        ...
        <tbody>
            ...
            foreach ($this->tableSchema->columns as $column) {
                ...
                if ($fieldType == 'hiddenfield') {
                    ...
                    <tr>
                        <td height="10px"></td>
                        <td><?php echo "<?php echo " . $this->generateActiveField($this->modelClass, $column, $fieldType, $addParam) . "; ?>\n"; ?></td>
                        <td></td>
                    </tr>
           <?php
                } else {
