...
");
?>
<h1>Custom Generator</h1>

<p>This generator generates a controller and views that implement CRUD Custom operations for the specified data model.</p>

<?php $form=$this->beginWidget('CCustomCodeForm', array('model'=>$model)); ?>
