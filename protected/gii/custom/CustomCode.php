	...
	public function prepare()
	{
		...
		$this->files[]=new CCodeFile(
			...
			$this->render($controllerTemplateFile)
                ...
                $this->files[] = new CCodeFile(
                        Yii::getPathOfAlias('webroot' . '.' . 'assets/js/app/model/' . $this->modelClass) . '.js', $this->render($templatePath . DIRECTORY_SEPARATOR . 'app/model/model.php')
                );
                
                /*$this->files[] = new CCodeFile(
                        Yii::getPathOfAlias('webroot' . '.' . 'assets/js/app/controller/' . $this->modelClass) . 'Controller.js', $this->render($templatePath . DIRECTORY_SEPARATOR . 'app/controller/controller.php')
                );*/
                
                $this->files[] = new CCodeFile(
                        Yii::getPathOfAlias('webroot' . '.' . 'assets/js/app/store/' . $this->modelClass) . '.js', $this->render($templatePath . DIRECTORY_SEPARATOR . 'app/store/store.php')
                );
				$this->files[] = new CCodeFile(
                        Yii::getPathOfAlias('webroot' . '.' . 'assets/js/app/view/' . $this->modelClass) . '/_grid.js', $this->render($templatePath . DIRECTORY_SEPARATOR . 'app/view/_grid.php')
                );
				$this->files[] = new CCodeFile(
                        Yii::getPathOfAlias('webroot' . '.' . 'assets/js/app/view/' . $this->modelClass) . '/_form.js', $this->render($templatePath . DIRECTORY_SEPARATOR . 'app/view/_form.php')
                );
