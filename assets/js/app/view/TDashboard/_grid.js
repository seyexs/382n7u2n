Ext.define('Esmk.view.TDashboard._grid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.tdashboardGrid',
	id:'tdashboardgridid',
    requires: [
        'Ext.toolbar.Paging',
    ...
    initComponent: function() {
        var me = this;
		this.store=Ext.create('Esmk.store.TDashboard');
        Ext.applyIf(me, {
            columns: [
                {
                    xtype: 'rownumberer',
	...
	actionDbClick: function(dataview, record, item, index, e, options){
        var formTDashboard = Ext.create('Esmk.view.TDashboard._form');

        if (record) {

            formTDashboard.down('form').loadRecord(record);
    ...
    actionSearch: function(button) {
		...
		grid.getStore().getProxy().api.read='TDashboard/read/?q='+values;
    },
});
