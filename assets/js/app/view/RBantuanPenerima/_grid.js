Ext.define('Esmk.view.RBantuanPenerima._grid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.rbantuanpenerimaGrid',
	id:'rbantuanpenerimagridid',
    requires: [
        'Ext.toolbar.Paging',
    ...
    initComponent: function() {
        var me = this;
		this.store=Ext.create('Esmk.store.RBantuanPenerima');
        Ext.applyIf(me, {
            columns: [
                {
                    xtype: 'rownumberer',
	...
	actionDbClick: function(dataview, record, item, index, e, options){
        var formRBantuanPenerima = Ext.create('Esmk.view.RBantuanPenerima._form');

        if (record) {

            formRBantuanPenerima.down('form').loadRecord(record);
    ...
    actionSearch: function(button) {
		...
		grid.getStore().getProxy().api.read='RBantuanPenerima/read/?q='+values;
    },
});
