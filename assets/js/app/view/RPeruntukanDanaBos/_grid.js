Ext.define('Esmk.view.RPeruntukanDanaBos._grid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.rperuntukandanabosGrid',
	id:'rperuntukandanabosgridid',
    requires: [
        'Ext.toolbar.Paging',
    ...
    initComponent: function() {
        var me = this;
		this.store=Ext.create('Esmk.store.RPeruntukanDanaBos');
        Ext.applyIf(me, {
            columns: [
                {
                    xtype: 'rownumberer',
	...
	actionDbClick: function(dataview, record, item, index, e, options){
        var formRPeruntukanDanaBos = Ext.create('Esmk.view.RPeruntukanDanaBos._form');

        if (record) {

            formRPeruntukanDanaBos.down('form').loadRecord(record);
    ...
    actionSearch: function(button) {
		...
		grid.getStore().getProxy().api.read='RPeruntukanDanaBos/read/?q='+values;
    },
});
