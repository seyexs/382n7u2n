Ext.define('Esmk.view.RBantuan._form', {
    //extend: 'Ext.form.Panel', //use this code for panel form
    extend: 'Ext.window.Window',
    alias: 'widget.rbantuanForm',
    requires: ['Ext.form.Panel',
        'Ext.form.field.Text',
        'Ext.ux.DataTip',
        'Ext.data.*'
    ],
    title: 'Esmk - Form Jenis Bantuan',
    layout: 'fit',
    autoShow: true,
    width: 600,
    autoHeight:true,
	...
	actionSave: function(button) {
        ...
        if (values.id !='') {
            ...
            record = Ext.create('Esmk.model.RBantuan');
            record.set(values);
            Ext.getCmp('rbantuangridid').getStore().add(record);
            isNewRecord = true;
        }
		Ext.getCmp('rbantuangridid').getStore().reload();
        win.close();
    },
});
