Ext.define('Esmk.view.RBantuan._grid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.rbantuanGrid',
	id:'rbantuangridid',
    requires: [
        'Ext.toolbar.Paging',
    ...
    initComponent: function() {
        var me = this;
		this.store=Ext.create('Esmk.store.RBantuan');
        Ext.applyIf(me, {
            columns: [
                {
                    xtype: 'rownumberer',
	...
	actionDbClick: function(dataview, record, item, index, e, options){
        var formRBantuan = Ext.create('Esmk.view.RBantuan._form');
	...
	actionDelete: function(button) {
		var grid = Ext.getCmp('rbantuangridid');
    ...
    actionSearch: function(button) {
		...
		grid.getStore().getProxy().api.read='RBantuan/read/?q='+values;
    },
});
