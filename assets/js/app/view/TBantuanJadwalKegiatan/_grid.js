Ext.define('Esmk.view.TBantuanJadwalKegiatan._grid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.tbantuanjadwalkegiatanGrid',
	id:'tbantuanjadwalkegiatangridid',
    requires: [
        'Ext.toolbar.Paging',
    ...
    initComponent: function() {
        var me = this;
		this.store=Ext.create('Esmk.store.TBantuanJadwalKegiatan');
		this.store.getProxy().api.read='TBantuanJadwalKegiatan/read/?tbid='+this.t_bantuan_program_id;
        Ext.applyIf(me, {
            columns: [
                {
                    xtype: 'rownumberer',
                 ...
                 
                {
                    ...
                    text: 'Deskripsi Waktu Pelsaksanaan',
                    flex:true,
	...
	actionDbClick: function(dataview, record, item, index, e, options){
        var formTBantuanJadwalKegiatan = Ext.create('Esmk.view.TBantuanJadwalKegiatan._form',{
			t_bantuan_program_id:this.t_bantuan_program_id
		});

        if (record) {

            formTBantuanJadwalKegiatan.down('form').loadRecord(record);
    ...
    actionSearch: function(button) {
		...
		grid.getStore().getProxy().api.read='TBantuanJadwalKegiatan/read/?q='+values;
    },
});
